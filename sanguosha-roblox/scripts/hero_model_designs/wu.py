...
def sun_shangxiang(meta, base):
    ...
    hero.add("HighPonyBase", "Head", (0, 1.30, 0.20), (0.66, 0.32, 0.62), "#18151C")
    hero.add("HighPonyTailA", "Head", (-0.44, 1.18, 0.82), (0.30, 1.40, 0.24), "#18151C", rot=(-24, 0, -34), mat="Fabric")
    hero.add("HighPonyTailB", "Head", (-0.12, 1.08, 1.02), (0.26, 1.22, 0.22), "#18151C", rot=(-32, 0, -10), mat="Fabric")
    hero.add("HighPonyTailC", "Head", (-0.70, 0.96, 0.70), (0.22, 0.94, 0.18), "#18151C", rot=(-12, 0, -46), mat="Fabric")
    hero.add("RedPonyRibbon", "Head", (-0.18, 1.20, 0.66), (0.74, 0.16, 0.10), "#C92A3A", rot=(0, 0, -16), mat="Fabric")
